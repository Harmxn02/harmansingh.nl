const projects = [
	{
		...
		imageSrc: "https://placehold.co/600x400/?text=CPEP",
		domain: "ML/AI",
		technologies: ["Python", "Streamlit", "Microsoft Azure"],
		description:
			"AI-driven solution to assist consultants in generating more accurate project estimations based on historical data",
